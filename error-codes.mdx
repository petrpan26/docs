...
|--------|---------|-------------|
| 400 | Bad Request | `CS-ORIV-*` |
| 401 | Unauthorized | `CS-ORAU-*` |
| 402 | Payment Required | `CS-ORCR-*` |
| 404 | Not Found | `CS-ORJC-001` |
| 410 | Gone | `CS-ORJC-003` |
| 500 | Server Error | `CS-ENEC-*`, `CS-RNRD-*`, `CS-MGMR-*` |
  ...
  <Accordion title="Handle processing failures">
    ...
    while True:
        ...
        if status["status"] == "complete":
            ...
            print(f"Job failed: {code} - {status.get('error')}")
