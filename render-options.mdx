...
<ParamField body="model" default="V4_Preview" type="string">
...
<AccordionGroup>
  ...
  <Accordion title="Performance optimization">
    Enable **fast** mode for 2x rendering speed. Costs 2x credits. Requires a driving\_video upload or scene\_id.
  </Accordion>
</AccordionGroup>