...
```json
{
  ...
  "status": "complete",
  "cdn_url": "https://assets.viggle.ai/videos/job_abc123xyz/output.mp4",
  "mask_cdn_url": "https://assets.viggle.ai/videos/job_abc123xyz/output_mask.mp4",
...
<AccordionGroup>
  <Accordion title="Use HD for best compositing quality">
    Set `resolution=HD` to get the highest quality output for compositing workflows where detail matters.
  </Accordion>
