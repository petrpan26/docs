...
Upload a driving video to create a reusable scene. The scene extracts motion data that can be applied to characters.

<Info>
  **Credits**: 1 credit/sec is held during preprocessing and **automatically refunded** when your first render starts. Preprocessing is effectively free.
</Info>
